...
const asn1 = require('asn1.js'); // Crypto-conditions always use the same RSA exponent, namely 65537
...
class Pem {
  ...
  static modulusFromPrivateKey(privateKey) {
    const pem = privateKey.replace('-----BEGIN RSA PRIVATE KEY-----', '').replace('-----END RSA PRIVATE KEY-----', '').replace(/\s+|\n\r|\n|\r$/gm, '');
