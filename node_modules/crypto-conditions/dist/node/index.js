...
const validateCondition = serializedCondition => {
  ...
  const condition = Condition.fromUri(serializedCondition); // Validate condition, throw on error
...
const validateFulfillment = (serializedFulfillment, serializedCondition, message) => {
  ...
  const fulfillment = Fulfillment.fromUri(serializedFulfillment); // Compare condition URI, throw on error
