...
class PrefixSha256 extends BaseSha256 {
  ...
  getSubtypes() {
    const subtypes = new Set([...this.subcondition.getSubtypes(), this.subcondition.getTypeName()]); // Never include our own type as a subtype. The reason is that we already
  ...
  calculateCost() {
    ...
    const subconditionCost = this.subcondition instanceof Condition ? this.subcondition.getCost() : this.subcondition.getCondition().getCost();
