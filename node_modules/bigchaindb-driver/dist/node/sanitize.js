...
function filterFromObject(obj, filter, {
  ...
  if (filter && (0, _isArray.default)(filter)) {
    return applyFilterOnObject(obj, isInclusion ? val => (0, _includes.default)(filter).call(filter, val) : val => !(0, _includes.default)(filter).call(filter, val));
  } else if (filter && typeof filter === 'function') {
    // Flip the filter fn's return if it's for inclusion
    return applyFilterOnObject(obj, isInclusion ? filter : (...args) => !filter(...args));
  } else {
